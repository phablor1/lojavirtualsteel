...
--
-- Host: steel_db
-- Tempo de geração: 03/10/2023 às 13:31
...
(1, 'Safety Stop', 'lorem-ipsum-is', '/storage/photos/1/Banner/produto1.png', '<h2><span style=\"font-weight: bold; color: rgb(99, 99, 99);\">Desconto 10%</span></h2>', 'active', '2020-08-14 01:47:38', '2023-10-01 23:06:33'),
(2, 'Safety Stop', 'lorem-ipsum', '/storage/photos/1/Banner/prod2trans(1).jpg', '<p>Up to 90%</p>', 'active', '2020-08-14 01:50:23', '2023-09-27 16:54:28'),
...
(7, 'SteelPortas', 'steelportas', 'active', '2023-09-28 00:34:17', '2023-09-28 00:34:17');
...
(12, 6, 6, 1, 5820.00, 'new', 1, 6000.00, '2023-10-01 23:11:09', '2023-10-01 23:13:07');
...
(1, 'Masculina', 'mens-fashion', NULL, '/storage/photos/1/Category/mini-banner1.jpg', 1, NULL, NULL, 'active', '2020-08-14 04:26:15', '2023-10-01 23:21:26'),
(2, 'Moda Feminina', 'womens-fashion', NULL, '/storage/photos/1/Category/mini-banner2.jpg', 1, NULL, NULL, 'active', '2020-08-14 04:26:40', '2023-09-30 02:36:32'),
(3, 'Segurança', 'kids', NULL, '/storage/photos/1/Category/mini-banner3.jpg', 1, NULL, NULL, 'active', '2020-08-14 04:27:10', '2023-09-27 02:05:04'),
...
('a0ea1ce4-a25c-4a4a-94cd-fe8843eef5a5', 'App\\Notifications\\StatusNotification', 'App\\User', 1, '{\"title\":\"New order created\",\"actionURL\":\"http:\\/\\/loja.conectx.cloud\\/admin\\/order\\/6\",\"fas\":\"fa-file-alt\"}', NULL, '2023-10-01 23:13:07', '2023-10-01 23:13:07'),
...
(6, 'ORD-HKRAZSKOAZ', 1, 6000.00, NULL, NULL, 6000.00, 1, 'cod', 'unpaid', 'new', 'Phablo', 'renan', 'admin@gmail.com', '11969489493', 'BR', NULL, 'rua teste', NULL, '2023-10-01 23:13:07', '2023-10-01 23:13:07');
...
(1, 'Somos uma empresa dedicada e apaixonada por oferecer soluções completas para portas de enrolar. Com anos de experiência na indústria, nos especializamos na fabricação de acessórios de alta qualidade para portas de enrolar, garantindo durabilidade, segurança e desempenho excepcionais.<br><br>Nossos produtos são projetados para atender às diversas necessidades dos nossos clientes, desde acessórios que melhoram a funcionalidade das portas até componentes que aumentam a segurança. Além disso, também oferecemos serviços de manutenção especializados, assegurando que suas portas estejam sempre em perfeito estado de funcionamento.<br><br>Na Steelporta, acreditamos que cada projeto é único e merece atenção dedicada. Temos engenheiro que trabalham em estreita colaboração com você, desde a concepção até a implementação, para garantir que cada detalhe seja cuidadosamente considerado, seja para projetos residenciais, comerciais ou industriais, estamos aqui para tornar suas ideias em realidade.<br><br>Nossa equipe é composta por profissionais experientes e comprometidos, prontos para oferecer assistência personalizada e orientação técnica para atender às suas demandas únicas.<br><br>Explore o nosso site para conhecer mais sobre os nossos produtos, serviços e a qualidade que a Steelporta representa. Entre em contato conosco para obter mais informações, solicitar um orçamento ou agendar serviços de manutenção. Estamos ansiosos para colaborar no sucesso dos seus projetos relacionados a portas de enrolar ou serviços de usinagem.', 'Somos uma empresa dedicada e apaixonada por oferecer soluções completas para portas de enrolar. Com anos de experiência na indústria, nos especializamos na fabricação de acessórios de alta qualidade para portas de enrolar, garantindo durabilidade, segurança e desempenho excepcionais.<br>', '/storage/photos/1/logosteeltranspa.jpg', '/storage/photos/1/Blog/imgsyeel.jpeg', 'Av.Aricanduva, 012 Sao Paulo', '11986233178', 'steel@gmail.com', NULL, '2023-09-28 03:10:12');
...
--
-- Despejando dados para a tabela `shippings`
--
...
(1, 'Phablo Renan', 'admin@gmail.com', NULL, '$2y$10$GOGIJdzJydYJ5nAZ42iZNO3IL1fdvXoSPdUOH3Ajy5hRmi0xBmTzm', '/storage/photos/1/users/perfil.jpg', 'admin', NULL, NULL, 'active', 'j3HsNG66YHyVUW5Y8JEiLq3OT3zcg2RHpodDxujcIKtAu0IKaLUX7Tf1h54g', NULL, '2023-09-27 17:06:50');
...
--
-- Restrições para tabelas `product_reviews`
--
ALTER TABLE `product_reviews`
