...
@endsection
@section('title','STEEL-SHOP || DETALHE PRODUTO')
					...
					<div class="col-12">
						<div class="bread-inner">
							<ul class="bread-list">
								...
								<li class="active"><a href="">Detalhes da compra</a></li>
							</ul>
						</div>
					</div>
				</div>
								...
								<div class="row">
									...
									<div class="col-lg-6 col-12">
										<div class="product-des">
											...
											<!-- Color -->
											{{-- <div class="color">
												<h4>Opções disponiveis <span>Cor</span></h4>
												<ul>
														...
														<div class="row">
															<div class="col-12">
																...
																<p class="text-center p-5">
																	Você precisar <a href="{{route('login.form')}}" style="color:rgb(54, 54, 204)">Login</a> ou <a style="color:blue" href="{{route('register.form')}}">Registrar</a>
																...
																<div class="ratting-main">
																	<div class="avg-ratting">
																		...
																		<span>Based on {{$product_detail->getReview->count()}} Comentarioss</span>
																	</div>
